...
class IR:
    def __init__(self, name, pins): #17
        self.name = name
        self.pin = pins
        ...
        self.button_names = ["LEFT",   "RIGHT",      "UP",       "DOWN",       "2",          "3",          "1",        "OK",        "4",         "5",         "6",         "7",         "8",          "9",        "*",         "0",        "#"]
        ...
        #             print(self.button_names[button]) #Prints corresponding english name for button


def run_ir_loop(ir, delay, callback, stop_event, settings, publish_event):
    while True:
