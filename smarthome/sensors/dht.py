...
class DHT:
    ...
    # Read DHT sensors, store the original data in bits[]
    ...
    # Read DHT sensors, analyze the data of temperature and humidity
    def readDHT11(self):
...
def run_dht_loop(dht, delay, callback, stop_event, settings, publish_event):
    while True:
        ...
        callback(humidity, temperature, code, settings, publish_event)
